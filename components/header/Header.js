                        ...
                        <div className={styles.divDesktop}>
                            <nav className={styles.navDesktop}>
                                <ul className={styles.iconLink}>
                                    <li><a href='https://github.com/Renanincio' target='_blank' className={styles.iconA}><AiFillGithub /></a></li>
                                    <li><a href='https://www.linkedin.com/in/renan-inacio-968401240/' target='_blank' className={styles.iconA}><AiFillLinkedin /></a></li>
                                </ul>
                                <ul>
                                    <li>
